            ...
            <div className="subContainer height100">
                ...
                <div className="col-xs-12 padding10">
                    <div className="filterPanel">
                        ...
                        <span className="filterHeader sortedFilter">Odds type:</span>
                        <div className="list zoomSettingsList">
                            <ul className="zooming">
                                <div className="selectContainer">
                                    <select name="per_page" className="zoomOption">
                        ...
                        <div className="filtersList list">
                            ...
                            <ul>
                                <li>
                                    <input type="checkbox" value="28783" id="sidebar_filter28783" name="demo"
                                            checked="true"/>
                        ...
                        <span className="filterHeader">Hidden:</span>
                        <div>
                            <ul style={{textDecoration:"none",paddingInlineStart:"0px"}}>
                                <li style={{lineHeight:"1"}}>
                                    <a style={{color:"#3C92C5",fontSize:"12px"}} href="#">0</a><span style={{color:"#3C92C5",fontSize:"12px"}}> arbs</span>
                                </li>
                                <li style={{lineHeight:"1"}}>
                                    <a style={{color:"#3C92C5",fontSize:"12px"}} href="#">0</a><span style={{color:"#3C92C5",fontSize:"12px"}}> events</span>
                                </li>
                                <li style={{lineHeight:"1"}}>
                                    <a style={{color:"#3C92C5",fontSize:"12px"}} href="#">0</a><span /><span style={{color:"#3C92C5",fontSize:"12px"}}> outcomes</span>
                                </li>
                                <li style={{lineHeight:"1"}}>
                                    <span><a style={{color:"#3C92C5",fontSize:"12px"}} href="#">1</a></span><span style={{color:"#3C92C5",fontSize:"12px",lineHeight:"0.5"}}> bookmaker events</span>
                                </li>
                            </ul>
                        </div>
