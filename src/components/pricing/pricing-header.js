                    ...
                    <div style={{display:"flex",alignItems:"center",justifyContent:"center"}}>
                        ...
                        <div className="dropdown language-select drop-lang lang-dropdown">
                            ...
                            <ul aria-labelledby="drop-language" className="dropdown-menu dropdown-language">
                                <li>
                                    <a style={{marginRight:"0px"}} className="actual" href="/pricing">
                                        <div className="lang-btn__flag lang-btn_long">
                                            <img alt="English" src="../assets/img/en-e9ca840a7fc16c0ce06d06c817a3460df10b970e31cd4697d3f1ecc163fba92b.png" />
                                            English
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a style={{marginRight:"0px"}} className="notactual" href="/pt_pricing">
                                        <div  className="lang-btn__flag lang-btn_long">
                                            <img alt="Portugal"
