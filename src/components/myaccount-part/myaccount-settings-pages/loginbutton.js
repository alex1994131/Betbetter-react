    ...
    return (
        ...
        <div className="col-md-10 header">
            <div className="section">
                <h4 className="text-center">Unhappy?</h4>
                ...
                <div className="text-center">
                    <form className="button_to" method="post" action="https://www.betburger.com/users">
                        <input type="hidden" name="_method" value="delete" /><input
                            data-confirm="Are you sure?" className="btn red-btn" type="submit"
                            value="Delete my account" /><input type="hidden" name="authenticity_token"
