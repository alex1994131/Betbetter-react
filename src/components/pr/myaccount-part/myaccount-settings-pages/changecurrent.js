    ...
    return (
        ...
        <form className="editUserInfo row" onSubmit={this.handleSubmit} acceptCharset="UTF-8" method="post">
            <div className="info-holder form-group col-sm-6 col-md-12">
                <div className="row">
                    <div className="col-md-5 col-xs-12 no-desc">
                        <label htmlFor="betbetter_username">Nome 
                        </label>
                    </div>
            ...
            <div className="info-holder form-group col-sm-6 col-md-12 current-password-holder">
                <div className="row">
                    <div className="col-md-5 col-xs-12 with-desc">
                        <label className="with_description" htmlFor="betburger_user_current_password">Palavra-passe atual
                        </label><span className="small">(precisamos da sua palavra-passe atual para confirmar as suas alterações)</span>
                    </div>
                    <div className="col-md-5 col-xs-12 setting_input">
            ...
            <div className="info-holder form-group col-sm-6 col-md-12 new-password-holder">
                <div className="row">
                    <div className="col-md-5 col-xs-12 with-desc">
                        <label className="with_description" htmlFor="betburger_user_password">Nova palavra-passe
                        </label>
                        <span className="small">(deixe em branco se não pretender alterá-la)</span>
                    </div>
                    <div className="col-md-5 col-xs-12 setting_input">
